...
time /home/nv3le/opt/z3squashed/build/z3 fp.spacer.max_level=20 fp.spacer.dump_benchmarks=true fp.spacer.dump_threshold=99999 fp.spacer.use_expansion=false fp.spacer.arith.solver=6 fp.print_statistics=true fp.spacer.use_h_inductive_generalizer=false -v:1 -T:$CPU -memory:$MEM $1 
