if(NOT EXISTS "/home/nle/opt/z3grpc/build/install_manifest.txt")
  message(FATAL_ERROR "Cannot find install manifest: "
          "/home/nle/opt/z3grpc/build/install_manifest.txt")
endif()

file(READ "/home/nle/opt/z3grpc/build/install_manifest.txt" files)
...
foreach(file ${files})
  ...
  if(IS_SYMLINK "${_full_file_path}" OR EXISTS "${_full_file_path}")
    ...
    execute_process(COMMAND
      "/usr/bin/cmake" "-E" "remove" "${_full_file_path}"
