...
struct fp_params {
  ...
  static void collect_param_descrs(param_descrs & d) {
    ...
    d.insert("spacer.use_h_inductive_generalizer", CPK_UINT, "generalize lemmas using heuristic-based induction strengthening. 0 = no heuristic. 1, 2, 3, etc = index of the heuristic", "0","fp");
    d.insert("spacer.grpc_host_port", CPK_SYMBOL, "the address and port of the grpc server. Default to be localhost:50051", "localhost:50051","fp");
    d.insert("spacer.use_expansion", CPK_BOOL, "generalize lemmas using literal expansion", "true","fp");
    ...
    d.insert("spacer.print_json", CPK_SYMBOL, "Print pobs tree in JSON format to a given file", "null","fp");
    ...
    d.insert("spacer.use_snap_val_gen", CPK_BOOL, "Enable snapping numbers", "false","fp");
    d.insert("spacer.propagate_ugly", CPK_BOOL, "Propagate ugly lemma or not. Default = True.", "true","fp");
  ...
  */
  ...
  unsigned spacer_use_h_inductive_generalizer() const { return p.get_uint("spacer.use_h_inductive_generalizer", g, 0u); }
  symbol spacer_grpc_host_port() const { return p.get_sym("spacer.grpc_host_port", g, symbol("localhost:50051")); }
  bool spacer_use_expansion() const { return p.get_bool("spacer.use_expansion", g, true); }
  ...
  symbol spacer_print_json() const { return p.get_sym("spacer.print_json", g, symbol("null")); }
  ...
  bool spacer_use_snap_val_gen() const { return p.get_bool("spacer.use_snap_val_gen", g, false); }
  bool spacer_propagate_ugly() const { return p.get_bool("spacer.propagate_ugly", g, true); }
