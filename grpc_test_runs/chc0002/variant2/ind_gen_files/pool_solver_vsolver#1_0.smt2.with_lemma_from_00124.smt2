...
(assert (or (not spacer_proxy!0)
    (<= (+ invariant_10_n (* (- 1.0) invariant_11_n)) (- 61.0))
    (not |vsolver#1|)))
(assert (or (not invariant__tr1) (not |vsolver#1|) (not spacer_proxy!1)))
(assert (let ((a!1 (not (<= (+ invariant_10_n (* (- 1.0) invariant_11_n)) (- 61.0)))))
  (or |invariant#level_0!2| (not |vsolver#1|) a!1)))
(assert (let ((a!1 (not (<= (+ invariant_10_0 (* (- 1.0) invariant_11_0)) (- 61.0)))))
...
(assert (or (not |vsolver#1|)
    (not spacer_proxy!3)
    (>= (+ invariant_7_n (* (- 1.0) invariant_10_n)) 61.0)))
...
(assert (or (not |vsolver#1|)
    (<= (+ invariant_7_n (* (- 1.0) invariant_11_n)) (- 61.0))
    (not spacer_proxy!15)))
...
(act-lvl -1)
(ind-gen (let ((a!1 (not (>= (+ invariant_7_n (* (- 1.0) invariant_9_n)) 0.0)))
      (a!2 (not (>= (+ invariant_7_n (* (- 1.0) invariant_8_n)) 0.0))))
  (and (not invariant_3_n)
       invariant_1_n
       (not (>= invariant_0_n 1.0))
       a!1
       a!2
       (= invariant_2_n 1.0)
       (= invariant_5_n 1.0)
       (>= (+ invariant_8_n (* (- 1.0) invariant_9_n)) (- 20.0))
       (>= (+ invariant_9_n (* (- 1.0) invariant_10_n)) 61.0)
       (= invariant_6_n 1.0)
       (= invariant_11_n (- 1.0))))
)
