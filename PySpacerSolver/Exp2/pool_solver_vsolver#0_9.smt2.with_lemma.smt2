...
(:added-eqs          666
 ...
 :propagations       4186
 :time               0.00)
(params arith.solver 2 random_seed 0 dump_benchmarks true dump_threshold 0.00 mbqi true arith.ignore_int true array.weak true)(act-lvl 2)
(ind-gen (let ((a!1 (not (<= (+ (* (/ 1016.0 1523.0) INV_0_n)
                       (* (- (/ 1737360.0 485837.0)) INV_1_n))
                    (/ 294529077.0 684058496.0)))))
  (and (not INV_4_n)
       (not INV_5_n)
       (not INV_3_n)
