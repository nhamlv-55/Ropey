...
(:added-eqs          326
 ...
 :num-checks         42
 :propagations       1720)
(params arith.solver 2 random_seed 0 dump_benchmarks true dump_threshold 0 mbqi true arith.ignore_int true array.weak true)(act-lvl 4294967295)
(ind-gen (and INV_5_n (not INV_4_n) (not (>= INV_1_n (- (/ 9.0 44.0)))))
)
