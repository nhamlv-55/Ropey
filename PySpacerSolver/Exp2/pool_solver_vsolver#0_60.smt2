...
(assert (let ((a!1 (not (>= (+ (* (/ 144424960.0 3354923.0) INV_1_n)
                       (* (- (/ 180101120.0 3354923.0)) INV_2_n))
                    (/ 310748183.0 73808306.0)))))
  (or INV_5_n (not |vsolver#0|) |INV#level_4!17| a!1)))
(assert (let ((a!1 (not (>= (+ (* (/ 144424960.0 3354923.0) INV_1_0)
                       (* (- (/ 180101120.0 3354923.0)) INV_2_0))
                    (/ 310748183.0 73808306.0)))))
  (or INV_5_0 (not INV__tr0) (not |vsolver#0|) |INV#level_5!19| a!1)))
(assert (let ((a!1 (not (<= (+ (* (/ 12294373.0 99888960.0) INV_1_n)
                       (* (- (/ 1335659.0 12486120.0)) INV_2_n)
                       (* (/ 3354923.0 199777920.0) INV_0_n))
                    (/ 2954046511.0 562574622720.0)))))
...
(assert (let ((a!1 (not (>= (+ (* (/ 144424960.0 3354923.0) INV_1_n)
                       (* (- (/ 180101120.0 3354923.0)) INV_2_n))
                    (/ 310748183.0 73808306.0)))))
  (or INV_5_n (not |vsolver#0|) |INV#level_5!19| a!1)))
(assert (let ((a!1 (not (>= (+ (* (/ 144424960.0 3354923.0) INV_1_0)
                       (* (- (/ 180101120.0 3354923.0)) INV_2_0))
                    (/ 310748183.0 73808306.0)))))
  (or INV_5_0 (not INV__tr0) (not |vsolver#0|) |INV#level_6!21| a!1)))
(assert (let ((a!1 (not (<= (+ (* (/ 17747.0 14669.0) INV_1_n)
                       (* (/ 141976.0 44007.0) INV_0_n))
                    (/ 169151.0 484077.0)))))
  (or (not |vsolver#0|) (not spacer_proxy!94) a!1)))
(assert (or INV_3_0
    INV_4_0
    (not INV__tr0)
    (not |vsolver#0|)
    (not spacer_proxy!95)
    (<= (+ (* (/ 141976.0 44007.0) INV_0_0) (* (/ 17747.0 14669.0) INV_1_0))
        (/ 169151.0 484077.0))))
(assert (or INV_4_0
    (not INV__tr0)
    (not INV_5_0)
...
(assert (or INV_3_n
    ...
    (not |vsolver#0|)
    |INV#level_4!17|
    (<= (+ (* (/ 17747.0 14669.0) INV_1_n) (* (/ 141976.0 44007.0) INV_0_n))
        (/ 169151.0 484077.0))))
(assert (or INV_3_0
    (not INV__tr0)
    (not INV_5_0)
...
(assert (or (not INV__tr0) (not INV_4_0) (not |vsolver#0|) |INV#level_6!21|))
(assert (or (not INV_5_n)
    (not |vsolver#0|)
    |INV#level_5!19|
    (not (>= INV_1_n (/ 13.0 128.0)))))
...
(assert (let ((a!1 (not (<= (+ (* (/ 17747.0 14669.0) INV_1_n)
                       (* (/ 141976.0 44007.0) INV_0_n))
                    (/ 169151.0 484077.0)))))
  (or (not |vsolver#0|) (not spacer_proxy!99) a!1)))
(assert (or INV_5_n
    INV_3_n
    (not |vsolver#0|)
    |INV#level_6!21|
...
(assert (let ((a!1 (not (>= (+ (* (/ 144424960.0 3354923.0) INV_1_n)
                       (* (- (/ 180101120.0 3354923.0)) INV_2_n))
                    (/ 310748183.0 73808306.0)))))
  (or INV_5_n (not |vsolver#0|) |INV#level_6!21| a!1)))
(assert (let ((a!1 (not (>= (+ (* (/ 144424960.0 3354923.0) INV_1_0)
                       (* (- (/ 180101120.0 3354923.0)) INV_2_0))
                    (/ 310748183.0 73808306.0)))))
  (or INV_5_0 (not INV__tr0) (not |vsolver#0|) |INV#level_7!23| a!1)))
(assert (or (not |vsolver#0|)
    (not spacer_proxy!100)
    (>= (+ (* (/ 15.0 128.0) INV_1_n) (* (/ 5.0 16.0) INV_0_n))
        (/ 7546768765.0 196703772672.0))))
(assert (let ((a!1 (not (>= (+ (* (/ 5.0 16.0) INV_0_0) (* (/ 15.0 128.0) INV_1_0))
                    (/ 7546768765.0 196703772672.0)))))
  (or INV_3_0
      INV_4_0
      (not INV__tr0)
...
(assert (or (not INV__tr0) (not INV_4_0) (not |vsolver#0|) |INV#level_7!23|))
(assert (or (not INV_5_n)
    (not |vsolver#0|)
    |INV#level_6!21|
    (not (>= INV_1_n (/ 13.0 128.0)))))
...
(assert (let ((a!1 (not (>= (+ (* (/ 144424960.0 3354923.0) INV_1_n)
                       (* (- (/ 180101120.0 3354923.0)) INV_2_n))
                    (/ 310748183.0 73808306.0)))))
  (or INV_5_n (not |vsolver#0|) |INV#level_7!23| a!1)))
(assert (let ((a!1 (not (>= (+ (* (/ 144424960.0 3354923.0) INV_1_0)
                       (* (- (/ 180101120.0 3354923.0)) INV_2_0))
                    (/ 310748183.0 73808306.0)))))
  (or INV_5_0 (not INV__tr0) (not |vsolver#0|) a!1 |INV#level_8!25|)))
(assert (or (not |vsolver#0|)
...
(assert (let ((a!1 (not (<= (+ (* (/ 11.0 32.0) INV_1_n) (* (/ 1.0 4.0) INV_0_n))
                    (/ 15.0 5248.0)))))
  (or (not |vsolver#0|) a!1 (not spacer_proxy!107))))
(assert (or (not |vsolver#0|)
    (not spacer_proxy!108)
    (>= (+ (* (/ 115456.0 10517.0) INV_1_n) (* (/ 39360.0 10517.0) INV_0_n))
        (/ 10715.0 21034.0))))
(assert (let ((a!1 (not (>= (+ (* (/ 39360.0 10517.0) INV_0_0)
...
(assert (let ((a!1 (not (>= (+ (* (/ 115456.0 10517.0) INV_1_n)
                       (* (/ 39360.0 10517.0) INV_0_n))
                    (/ 10715.0 21034.0)))))
  (or INV_4_n INV_3_n (not INV_5_n) (not |vsolver#0|) a!1)))
(assert (let ((a!1 (not (>= (+ (* (/ 39360.0 10517.0) INV_0_0)
                       (* (/ 115456.0 10517.0) INV_1_0))
                    (/ 10715.0 21034.0)))))
  (or INV_3_0 INV_4_0 (not INV__tr0) (not INV_5_0) (not |vsolver#0|) a!1)))
(assert (let ((a!1 (not (>= (+ (* (/ 5.0 16.0) INV_0_0) (* (/ 15.0 128.0) INV_1_0))
                    (/ 7546768765.0 196703772672.0)))))
  (or INV_4_0
      (not INV__tr0)
...
(assert (let ((a!1 (not (>= (+ (* (/ 5.0 16.0) INV_0_0) (* (/ 15.0 128.0) INV_1_0))
                    (/ 7546768765.0 196703772672.0)))))
  (or INV_3_0 (not INV__tr0) (not |vsolver#0|) a!1 (not spacer_proxy!115))))
;; extra clause
...
(exit)
(:added-eqs          1914
 :arith-add-rows     24179
 :arith-assert-diseq 730
 :arith-assert-lower 4237
 :arith-assert-upper 2540
