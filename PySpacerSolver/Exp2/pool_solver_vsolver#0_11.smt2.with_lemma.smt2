...
(:added-eqs          695
 ...
 :num-checks         80
 :propagations       4575)
(params arith.solver 2 random_seed 0 dump_benchmarks true dump_threshold 0 mbqi true arith.ignore_int true array.weak true)(act-lvl 2)
(ind-gen (and (not INV_4_n) INV_3_n INV_5_n (>= INV_1_n (/ 13.0 128.0)))
)
