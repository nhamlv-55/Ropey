...
(exit)
(:added-eqs          1467
 :arith-add-rows     16664
 :arith-assert-diseq 518
 :arith-assert-lower 3002
 :arith-assert-upper 1861
 :arith-bound-prop   508
 :arith-conflicts    95
 ...
 :propagations       12535
 :time               0.02)
(params arith.solver 2 random_seed 0 dump_benchmarks true dump_threshold 0.00 mbqi true arith.ignore_int true array.weak true)(act-lvl 4)
