...
(exit)
(:added-eqs          1901
 :arith-add-rows     23777
 :arith-assert-diseq 723
 :arith-assert-lower 4191
 ...
 :propagations       17510
 :time               0.00)
(params arith.solver 2 random_seed 0 dump_benchmarks true dump_threshold 0.00 mbqi true arith.ignore_int true array.weak true)(act-lvl 6)
(ind-gen (let ((a!1 (not (<= (+ (* (/ 141976.0 44007.0) INV_0_n)
                       (* (/ 17747.0 14669.0) INV_1_n))
                    (/ 169151.0 484077.0)))))
  (and INV_5_n
       (not INV_3_n)
       (not INV_4_n)
