...
(:added-eqs          219
 ...
 :propagations       942
 :time               0.00)
(params arith.solver 2 random_seed 0 dump_benchmarks true dump_threshold 0.00 mbqi true arith.ignore_int true array.weak true)(act-lvl 1)
(ind-gen (let ((a!1 (not (<= (+ (* (- (/ 14637.0 4397.0)) INV_2_n)
                       (* (/ 4920.0 4397.0) INV_0_n)
