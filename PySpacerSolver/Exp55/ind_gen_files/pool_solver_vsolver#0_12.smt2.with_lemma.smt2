...
(:added-eqs                      645
 ...
 :arith-bound-propagations-cheap 477
 :arith-bound-propagations-lp    214
 :arith-conflicts                20
 :arith-diseq                    616
 :arith-fixed-eqs                5
 :arith-lower                    703
 :arith-make-feasible            431
 :arith-max-columns              55
 :arith-max-rows                 41
 :arith-propagations             477
 :arith-rows                     1826
 :arith-upper                    1115
 :conflicts                      82
 :decisions                      888
...
(ind-gen (let ((a!1 (not (<= (+ (* (/ 7.0 20.0) INV_1_n)
                       ...
                       INV_0_n)
                    (/ 11.0 160.0)))))
  (and (not INV_4_n) (not INV_3_n) (not INV_5_n) a!1))
)
