...
(:added-eqs                      1495
 ...
 :arith-bound-propagations-cheap 1619
 :arith-bound-propagations-lp    973
 :arith-conflicts                51
 :arith-diseq                    1492
 :arith-fixed-eqs                7
 :arith-lower                    2841
 :arith-make-feasible            1314
 :arith-max-columns              98
 :arith-max-rows                 84
 :arith-propagations             1619
 :arith-rows                     6240
 :arith-upper                    3391
 :conflicts                      177
 :decisions                      4385
...
(ind-gen (let ((a!1 (not (<= (+ (* (/ 7.0 20.0) INV_1_n) INV_0_n) (/ 11.0 160.0))))
      (a!2 (not (<= (+ (* (/ 21.0 640.0) INV_1_n) (* (/ 13.0 32.0) INV_0_n))
                    (/ 1.0 40.0)))))
  (and (not INV_3_n)
       a!1
       (<= (+ (* (/ 7.0 20.0) INV_1_n) INV_0_n) (/ 27.0 320.0))
