...
(:added-eqs                      1384
 ...
 :arith-bound-propagations-cheap 1493
 :arith-bound-propagations-lp    878
 :arith-conflicts                48
 :arith-diseq                    1392
 :arith-fixed-eqs                7
 :arith-lower                    2564
 :arith-make-feasible            1194
 :arith-max-columns              93
 :arith-max-rows                 79
 :arith-propagations             1493
 :arith-rows                     5707
 :arith-upper                    3135
 :conflicts                      169
 :decisions                      3936
...
(act-lvl 2)
(ind-gen (let ((a!1 (not (>= (+ (* (/ 11.0 32.0) INV_1_n) (* (/ 1.0 4.0) INV_0_n))
                    (- (/ 31.0 512.0)))))
      (a!2 (not (<= (+ (* (/ 7.0 64.0) INV_1_n) (* (/ 5.0 16.0) INV_0_n))
                    (/ 11.0 512.0)))))
  (and INV_5_n a!1 a!2))
)
